...
<div style="font-family: 'Georgia', serif; font-size: 1.15em; color: #2c3e50; line-height: 2; text-align: justify; padding: 40px; max-width: 100%; 
    ...
    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 8px; background: linear-gradient(to right, #f5a623, #8e44ad);"></div>
    ...
    <p style="margin-bottom: 30px;">Türk edebiyatı tarihinin en sıra dışı, en "aykırı" ve belki de en çok tartışılan dönemi hangisidir diye sorsak, pek çok kişinin cevabı <strong>İkinci Yeni</strong> olacaktır. 1950’li yıllarda ortaya çıkan bu akım, alışılmış kalıpları yıkarak şiiri bambaşka bir boyuta taşıdı.</p>
